...
To show the performance penalty of of using the gap extension penalty, each
run is compared to the timing on the same hardware with a gap extension. 

```{r echo=FALSE}
plot(c(0,max(cpuOclSingle$V1)),c(0,3), pch='o', cex=0.6, xlab="Number of alignments processed", ylab="Gap extension performance penalty", type="n", xaxt="n")

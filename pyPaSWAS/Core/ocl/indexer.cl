...
__kernel void calculateDistance(__global int *index, __global int *query, __global float *distances, float scale, int length){
	...
	if (get_group_id(0) * BLOCK_SIZE + get_group_id(1) < length) {
